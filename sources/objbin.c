...
/* =========================================
   *****************************************
   ...
   =========================================
   ***************************************** */
globle DEFCLASS *defclassArray = NULL;
...
static DEFCLASS_MODULE *ModuleArray;
static DEFCLASS * *linkArray = NULL;
static SLOT_DESC *slotArray = NULL;
static SLOT_DESC * *tmpslotArray = NULL;
static SLOT_NAME *slotNameArray = NULL;
static unsigned *mapslotArray = NULL;
static HANDLER *handlerArray = NULL;
static unsigned *maphandlerArray = NULL;
