...
/****************************************/
   ...
   globle struct entityRecord   FactJNGV1Info = { "FACT_JN_VAR1", FACT_JN_VAR1,0,1,0,
                                                  PrintFactJNGetVar1,
                                                  PrintFactJNGetVar1,NULL,
                                                  FactJNGetVar1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactJNGV2Info = { "FACT_JN_VAR2", FACT_JN_VAR2,0,1,0,
                                                  PrintFactJNGetVar2,
                                                  PrintFactJNGetVar2,NULL,
                                                  FactJNGetVar2,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactJNGV3Info = { "FACT_JN_VAR3", FACT_JN_VAR3,0,1,0,
                                                  PrintFactJNGetVar3,
                                                  PrintFactJNGetVar3,NULL,
                                                  FactJNGetVar3,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactPNGV1Info = { "FACT_PN_VAR1", FACT_PN_VAR1,0,1,0,
                                                  PrintFactPNGetVar1,
                                                  PrintFactPNGetVar1,NULL,
                                                  FactPNGetVar1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactPNGV2Info = { "FACT_PN_VAR2", FACT_PN_VAR2,0,1,0,
                                                  PrintFactPNGetVar2,
                                                  PrintFactPNGetVar2,NULL,
                                                  FactPNGetVar2,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactPNGV3Info = { "FACT_PN_VAR3", FACT_PN_VAR3,0,1,0,
                                                  PrintFactPNGetVar3,
                                                  PrintFactPNGetVar3,NULL,
                                                  FactPNGetVar3,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactJNCV1Info = { "FACT_JN_CMP1", FACT_JN_CMP1,0,1,1,
                                                  PrintFactJNCompVars1,
                                                  PrintFactJNCompVars1,NULL,
                                                  FactJNCompVars1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactJNCV2Info = { "FACT_JN_CMP2", FACT_JN_CMP2,0,1,1,
                                                  PrintFactJNCompVars2,
                                                  PrintFactJNCompVars2,NULL,
                                                  FactJNCompVars2,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactPNCV1Info = { "FACT_PN_CMP1", FACT_PN_CMP1,0,1,1,
                                                  PrintFactPNCompVars1,
                                                  PrintFactPNCompVars1,NULL,
                                                  FactPNCompVars1,
                                                  NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactStoreMFInfo = { "FACT_STORE_MULTIFIELD",
                                                    FACT_STORE_MULTIFIELD,0,1,0,
                                                    NULL,NULL,NULL,
                                                    FactStoreMultifield,
                                                    NULL,NULL,NULL,NULL,NULL,NULL };

   globle struct entityRecord   FactSlotLengthInfo = { "FACT_SLOT_LENGTH",
   ...
   globle struct entityRecord   FactPNConstant1Info = { "FACT_PN_CONSTANT1",
   ...
   globle struct entityRecord   FactPNConstant2Info = { "FACT_PN_CONSTANT2",
...
globle struct expr *FactGenGetfield(
  struct lhsParseNode *theNode)
  {
   ...
   if ((theNode->slotNumber > 0) && (theNode->withinMultifieldSlot == FALSE))
     { return(GenConstant(FACT_PN_VAR2,FactGetVarPN2(theNode))); }
   ...
   if (((theNode->type == SF_WILDCARD) || (theNode->type == SF_VARIABLE)) &&
     ...
     { return(GenConstant(FACT_PN_VAR3,FactGetVarPN3(theNode))); }
   ...
   return(GenConstant(FACT_PN_VAR1,FactGetVarPN1(theNode)));
  }
...
globle struct expr *FactGenGetvar(
  struct lhsParseNode *theNode)
  {
   ...
   if ((theNode->slotNumber > 0) && (theNode->withinMultifieldSlot == FALSE))
     { return(GenConstant(FACT_JN_VAR2,FactGetVarJN2(theNode))); }
   ...
   if (((theNode->type == SF_WILDCARD) || (theNode->type == SF_VARIABLE)) &&
       ((theNode->multiFieldsBefore == 0) ||
        ((theNode->multiFieldsBefore == 1) && (theNode->multiFieldsAfter == 0))))
     { return(GenConstant(FACT_JN_VAR3,FactGetVarJN3(theNode))); }
   ...
   return(GenConstant(FACT_JN_VAR1,FactGetVarJN1(theNode)));
  }
